...
public class AdapterResultado extends ArrayAdapter<TripleString> {

	public AdapterResultado(Context context, ArrayList<TripleString> ts) {
		super(context, 0, ts);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(getContext()).inflate(R.layout.elemento_lista_resultado, parent, false);
		}
		...
		TextView predicado = (TextView) convertView.findViewById(R.id.resPredicado);
		...
		predicado.setText(ts.getPredicado());
